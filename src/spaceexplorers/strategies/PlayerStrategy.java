...
public class PlayerStrategy implements IStrategy {
    ...
    /**
     * Method where students can observe the state of the system and schedule events
     * to be executed.
     *
     * @param planets          The current state of the system.
     * @param planetOperations Helper methods students can use to interact with the
     *                         system.
     * @param eventsToExecute  Queue students will add to in order to schedule
     *                         events.
     */
    @Override
